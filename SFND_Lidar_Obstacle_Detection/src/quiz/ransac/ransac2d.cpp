...
pcl::PointCloud<pcl::PointXYZ>::Ptr CreateData3D()
{
	...
	pcl::PointCloud<pcl::PointXYZ>::Ptr inputCloud=  pointProcessor.loadPcd("../../../sensors/data/pcd/data_1/0000000000.pcd");
	// return inputCloud;	//
	return pointProcessor.FilterCloud(inputCloud, 0.18, Eigen::Vector4f(-10,-5,-3,1),Eigen::Vector4f(30,7,3,1));
}
